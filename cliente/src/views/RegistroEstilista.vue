                ...
                <div class="row registro1 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <form>
                        ...
                        <div class="campos-formulario">
                            ...
                            <input v-model="estilista.identificacion" type="text" id="identificacion" name="identificacion"
                                placeholder="Ingrese su identificación" required class="formato">
                        </div>
                        <div class="campos-formulario">
                            <label>Nombres</label><br>
                            <input v-model="estilista.nombres" type="text" id="nombre" name="nombre" placeholder="Ingrese su nombre" required
                                class="formato">
                        </div>
                        <div class="campos-formulario">
                            <label>Apellidos</label><br>
                            <input v-model="estilista.apellidos"  type="text" id="apellidos" name="apellidos" placeholder="Ingrese sus apellidos"
                                required class="formato">
                        </div>

                        <div class="campos-formulario">
                            <label>Fecha de nacimiento</label><br>
                            <input v-model="estilista.fecha_nacimiento"  type="date" id="fecha_nacimiento" name="fecha_nacimiento" required class="formato">
                        </div>
                        <div class="campos-formulario">
                            <label>Dirección</label><br>
                            <input v-model="estilista.direccion"  type="text" id="direccion" name="direccion" placeholder="Ingrese su dirección"
                                required class="formato">
                        </div>

                        <div class="campos-formulario">
                            <label>Ciudad</label><br>
                            <input v-model="estilista.ciudad"  type="text" id="ciudad" name="ciudad" placeholder="Ingrese la ciudad" required
                                class="formato">
                        </div>

                        <div class="campos-formulario">
                            <label>Departamento</label><br>
                            <input v-model="estilista.departamento"  type="text" id="departamento" name="departamento"
                ...
                <div class="row registro2 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <form >
                        ...
                        <div class="campos-formulario">
                            ...
                            <input v-model="estilista.password"  type="password" id="password" name="password" placeholder="Ingrese contraseña"
                                required class="formato">
                        </div>
                        ...
                        <div class="campos-formulario form-group">
                            <div class="form-check">
                                ...
                                <input v-model="estilista.terminos" type="checkbox" class="form-check-input is-invalid" id="tratamiento_datos" name="tratamiento_datos" required>
