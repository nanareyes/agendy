                ...
                <div class="row registro1 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <form>
                        ...
                        <div class="campos-formulario">
                            ...
                            <input v-model="cliente.fecha_nacimiento"  type="date" id="fecha_nacimiento" name="fecha_nacimiento" required class="formato">
                        </div>
                        <div class="campos-formulario">
                ...
                <div class="row registro2 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <form >
                        ...
                        <div class="campos-formulario">
                            ...
                            <input v-model="cliente.email"  type="email" id="correo" name="email" placeholder="Ingrese correo electrónico"
                                required class="formato">
                        </div>
                        ...
                        <div class="campos-formulario">
                            ...
                            <input v-model="cliente.password" type="password" id="password" name="password"
